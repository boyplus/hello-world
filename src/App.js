...
export default class App extends React.Component {
  render() {
    ...
    return (
      ...
      <div style={{ border: "1px ", backgroundColor: "#E5E5E5" }}>

        <div class="container-fluid" style={{border:"1px solid red" ,width:"100%",margin:"0%"}} >
         <br/>
          ...
          <div style={{ backgroundImage: 'URL(/images/bgg23.png)', backgroundRepeat: "no-repeat", backgroundSize: "100%" }} >
            ...
            <div id="news" class="row"  >
              ...
              <div class="col-4 col-md-4 col-sm-4"> <a href="#two"><img src="/images/11.png" alt="logo 512" width="100%" /></a></div>


              <div class="col-4 col-md-4 col-sm-4"> <a href="#one"><img src="/images/44.png" alt="logo 512" width="100%" /></a></div>
              <div class="col-2 col-md-2 col-sm-2"></div>
            ...
            <div class="row">
              ...
              <div class="col-4 col-md-4 col-sm-4" mar>  <a href="#six1"><img src="/images/22.png" alt="logo 512" width="100%" style={{ marginTop: "50px" }} /></a></div>

              <div class="col-4 col-md-4 col-sm-4"><img src="/images/Logopng.png" alt="logo 512" width="100%" /></div>


              <div class="col-4 col-md-4 col-sm-4" >  <a href="#one"><img src="/images/555.png" alt="logo 512" width="100%" style={{ marginTop: "50px" }} /></a></div>
